    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">About SENC</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed">
                To become the leading provider of integrated technology solutions,
                connecting businesses with tools that drive growth, efficiency,
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed">
                To deliver exceptional software products that simplify complex processes,
                enhance productivity, and provide seamless user experiences through
                a unified platform that brings all our solutions together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Working together with our clients to achieve shared success.</p>
            </div>
            <div className="text-center">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Behind every great product is a team of passionate individuals dedicated
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <p className="text-gray-600 text-sm">
                Technical genius driving our engineering excellence and innovation.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
